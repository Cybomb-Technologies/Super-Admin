...
import styles from './cybombadmin.module.css';
    ...
    <div className={styles.container}>
      <div className={styles.header}>
        <h1 className={styles.title}>
          ...
          Cybomb Admin Management
        </h1>
        <p className={styles.subtitle}>Manage administrator accounts and passwords</p>
      </div>
      ...
      <div className={styles.tableContainer}>
        {admins.length === 0 && !loading ? (
          <div className={styles.emptyState}>
            ...
            <p>Create your first administrator account to get started.</p>
            <button 
            ...
            <div className={`modal-content ${styles.modalContent}`}>
              <div className={`modal-header ${styles.modalHeader}`}>
                <h5 className="modal-title">
                  <i className={`fas ${editingAdmin ? 'fa-edit' : 'fa-plus'} me-2`}></i>
                ...
                <div className={`modal-body ${styles.modalBody}`}>
                  ...
                  <div className="mb-3">
                    ...
                    <div className="form-text text-warning">
                      Password will be stored and displayed in plain text for admin visibility
                    </div>
                  </div>
                ...
                <div className={`modal-footer ${styles.modalFooter}`}>
                  ...
                  >
                    {loading ? (
                      ...
                      <>
                        <i className={`fas ${editingAdmin ? 'fa-save' : 'fa-plus'} me-2`}></i>
